...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $("#bearr-countdown-item").countdown("2017/10/28 12:00", function (event) {
      var $this = $(this).html(event.strftime('' + '<div class="countdown-col"><span class="countdown-time"> %-D </span> <span class="countdown-type"> Dias </span></div> ' + '<div class="countdown-col"><span class="countdown-time"> %H </span> <span class="countdown-type">Horas </span></div>' + '<div class="countdown-col"><span class="countdown-time"> %M </span> <span class="countdown-type">Minutos </span></div>' + '<div class="countdown-col"><span class="countdown-time"> %S </span> <span class="countdown-type">Segundos </span></div>'));
    });
    ...
    $("#contactForm").validate({
      ...
      submitHandler: function(form) {
        $.ajax({
          type: "POST",
          url: "https://formspree.io/costa.marcos.pro@gmail.com",
          data: {
